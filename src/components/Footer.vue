<template>
  <footer class="footer bg-dark r">
    <!-- <div class="container">
      <div class=""> -->
    <div class="footer-container r" style="margin-left:-5%;">
      <div class="column" >
        <h4 class="pt-4">Contacto:</h4>
      ...
      <div class="column" style="width:350px;">
        <h4 class="pt-4">Página creada con:</h4>
        <div class="r center">
          <a class="" target="_blank" href="https://vuejs.org/">
            <img class="a-img" src="../assets/logo.png" />
          </a>

          <a class="" target="_blank" href="https://firebase.google.com/">
            <img class="a-img" src="../assets/firebase.png" />
          </a>

          <a class="" target="_blank" href="https://getbootstrap.com/">
            <img class="a-img" src="../assets/bootstrap.png" />
          </a>

          <a class="" target="_blank" href="https://nodejs.org/es/">
            <img class="a-img" src="../assets/nodejs.png" />
          </a>
        </div>
      </div>
    </div>
