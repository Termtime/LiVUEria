    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-3 pt-4">
          ...
          <div class="row">
            <a class="col-3" target="_blank" href="https://vuejs.org/">
              <img class="a-img" src="../assets/logo.png" />
            </a>

            <a class="col-3" target="_blank" href="https://firebase.google.com/">
              <img class="a-img" src="../assets/firebase.png" />
            </a>

            <a class="col-3" target="_blank" href="https://getbootstrap.com/">
              <img class="a-img" src="../assets/bootstrap.png" />
            </a>

            <a class="col-3" target="_blank" href="https://nodejs.org/es/">
